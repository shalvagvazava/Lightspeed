...
class UIManager {
    ...
    showSuccessState() {
        ...
        this.announceToScreenReader("Поздравляю вы добавили все детали автомобиля в корзину и собрали автомобиль");
    }
...
class NotificationManager {
    ...
    static showSuccess() {
        NotificationManager.showAlert("🎊🎉 Поздравляю! 🎉🎊Вы собрали автомобиль!\n🎊🎉🎊🎉🎊");
    }

    static showAlreadySelected() {
        NotificationManager.showAlert('эта деталь уже в корзнине');
    }
    ...
    static createTitleFlasher() {
        ...
        const flasher = setInterval(() => {
            document.title = flashCount % 2 ? "🎉🎉" : "🚗 Машина собрана! 🚗";
            flashCount++;
            if (flashCount > 6) {
...
class CarConfigurator {
    ...
    handleCompletion() {
        ...
        setTimeout(() => {
            ...
            NotificationManager.updateTitle("🎉 Машина собрана🎉");
